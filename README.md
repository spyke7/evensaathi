...
│   └── models_v3/                 # Trained model artifacts (generated by notebooks)
│       ├── xgb_clean.pkl          # Task A: duration regression model
│       ├── feature_cols_clean.pkl # Feature name list for Task A
│       ├── global_tenc_clean.pkl  # Target encoding dictionaries
│       ├── label_encoders_clean.pkl # LabelEncoder objects
│       ├── xgb_road_closure.pkl   # Task B: road closure classifier
│       └── feature_cols_B.pkl     # Feature name list for Task B
├── frontend/
│   ├── src/
│   │   ├── App.jsx                # Main application component
│   │   ├── api.js                 # API client (fetchOptions, predict)
│   │   └── components/
│   │       ├── ImportanceChart.jsx
│   │       ├── ResourceCards.jsx
│   │       └── SimilarEvents.jsx
...
│   └── vite.config.js
└── notebooks/
    ├── fg2_exp3_2.ipynb           # Initial experimentation
    ├── fg2_exp3_2-Copy1.ipynb     # Cleaned-up rerun + documentation
    ├── fg2_clean1.ipynb           # Task A final model (duration regression)
    └── fg2_clean2.ipynb           # Task B final model (road closure)
```
...
**Backend:** Deploy to any Python ASGI host (Railway, Render, Fly.io, AWS EC2). Add CORS origin for your frontend URL in `main.py`.

**Frontend:** Deploy to Vercel, Netlify, or any static host. Set `VITE_API_URL` environment variable to your deployed backend URL.
